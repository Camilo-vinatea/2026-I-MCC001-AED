...
void CBTreePage<keyType, ObjIDType>::ForEach(Func func, tree_height_t level, Args&&... args)
{
...
CBTreePage<keyType, ObjIDType>::FirstThat(Func func, tree_height_t level, Args&&... args)
{
       Node *pTmp;
       for( auto i = 0 ; i < m_KeyCount ; ++i)
       {
